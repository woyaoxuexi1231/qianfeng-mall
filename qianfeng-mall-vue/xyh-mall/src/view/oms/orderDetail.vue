    ...
    <div class="detail-container">
        ...
        <el-card shadow="never" style="margin-top: 15px">
            ...
            <div style="margin-top: 20px">
                <svg-icon class="el-icon-collection-tag" style="color: #606266"></svg-icon>
...
export default {
    ...
    methods: {
        ...
        getOrderDetail(id){
            this.$axios.get('orders/order?id='+id)
                .then(res => {
                    this.order =res.data.data;
                    console.log(this.order);
                    this.$axios.get('orders/order/item?id='+id)
                    .then(res => {
